...
class GaleriaAdaptador(val context: Context, val nombreUsuario: String, val listaImagenes: ArrayList<String>): RecyclerView.Adapter<ViewHolderImagen>() {
    ...
    override fun onBindViewHolder(holder: ViewHolderImagen, position: Int) {
        ...
        holder.bindImagen(imagen, nombreUsuario)
    }
    ...
    inner class ViewHolderImagen(val binding: ImagenGaleriaBinding): RecyclerView.ViewHolder(binding.root) {
        ...
        fun bindImagen(imagen: String, nombreUsuario: String) {
